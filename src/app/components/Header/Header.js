    ...
    return (
        <nav
            ...
            <div
                ...
                {/* Logo */}
                <div
                    className="text-midnight text-2xl font-bold text-center md:col-end-1 px-4">
                    <Link href="/">NPTEL Quiz</Link>
                </div>
                ...
                <div
                    ...
                    <ul
                        ...
                        <li
                            className='font-bold hover:text-midnight  text-indigo-300'>
                            <Link
                                href="/">
                                Home
                            </Link>
